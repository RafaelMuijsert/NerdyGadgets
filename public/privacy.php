...
<br><br>
Als je je geboortedatum hebt opgegeven slaan we dit op om je op je verjaardag een verrassing te kunnen sturen.Ook kunnen we jouw geboortedatum gebruiken om Nerdygadgets.shop voor jou zo relevant mogelijk te maken. Je kan hierover meer lezen onder het kopje ‘Gegevens voor een optimale winkelbeleving’.
<br><br>
Daarnaast slaan wij in je account de door jou opgegeven interesses op, namelijk jouw verlanglijstje, eventuele gekoppelde Nerdygadgets.shop apps, taalvoorkeur en je e-mail- en personalisatievoorkeuren.
<br><br>
...
Je kan 24/7 contact opnemen met de klantenservice. Je kunt met ons bellen, e-mailen of chatten of een berichtje sturen via social media, zoals Facebook en Twitter. Je telefoonnummer in je klantaccount kunnen we daarbij gebruiken om je te herkennen als je onze klantenservice belt. Daardoor kunnen onze klantenservicemedewerkers je meteen helpen.
<br><br>
...
<br><br>
Een telefoongesprek met onze klantenservice wordt opgenomen voor trainings- en analysedoeleinden. Wij hebben een gerechtvaardigd belang om deze interacties te gebruiken om onze dienstverlening te kunnen verbeteren. Wij bewaren het telefoongesprek gedurende 1 maand.
<br><br>
Wanneer je ons een privéberichtje stuurt via Twitter of Facebook, worden de berichten maximaal 6 maanden door ons bewaard.
<br><br>
...
<br><br><br>
Gegevens voor een optimale winkelbeleving<br>
...
<br><br>
Allereerst zorgen we dat onze website of app goed werkt zodat jij optimaal kunt winkelen. Daarvoor verzamelen we bij een bezoek aan Nerdygadgets.shop jouw IP-adres, informatie over je internetbrowser, eventuele taalinstellingen en informatie over de instellingen van het besturingssysteem van de computer of het mobiele toestel waarmee je ons bezoekt.
<br><br>
Om je artikelen aan te bevelen, gebruiken we algemeen klantgedrag en statistieken. Als jij ons daarvoor toestemming geeft, kunnen wij Nerdygadgets.shop bovendien zo relevant mogelijk voor je maken door onze winkel af te stemmen op jouw persoonlijke voorkeuren (‘je eigen Nerdygadgets.shop’). Ook kunnen we je met jouw toestemming relevantere advertenties binnen en buiten Nerdygadgets.shop laten zien en je gepersonaliseerde berichten sturen. Hierna leggen we uit welke gegevens we gebruiken voor deze persoonlijke ervaring.
<br><br>
Verbeteren van de winkelbeleving gebaseerd op algemene informatie en verkoopstatistieken
Wanneer je op Nerdygadgets.shop een artikel bekijkt, zie je ook andere artikelen die we aanbevelen (bijvoorbeeld onder het kopje “Verder kijken” of “Anderen bekeken ook”). Deze aanbevelingen zijn gebaseerd op het artikel of de categorie waar je op dat moment naar kijkt. Op basis van statistieken weten we dat klanten die dat artikel kochten, ook geïnteresseerd waren in de andere artikelen. Deze aanbevelingen zijn niet persoonlijk: iedereen die dat artikel bekijkt ziet dezelfde aanbevelingen. Wij laten je daarom ook altijd deze aanbevelingen zien, ook als je niet hebt gekozen voor je eigen Nerdygadgets.shop. Als je zoekt naar een bepaald dekbedovertrek, ziet iedereen dezelfde vergelijkbare overtrekken of hoeslakens. Of we laten je op basis van je zoekopdracht zien wat andere gebruikers zochten. Deze vorm van het verbeteren van je winkelervaring zie je ook in een fysieke winkels. Zo staan artikelen van hetzelfde type of die bij elkaar horen meestal bij elkaar. En de verkoper weet ook wat populair is en wat andere klanten kochten toen ze met dezelfde vraag in de winkel kwamen.

Je eigen Nerdygadgets.shop<br><br>
...
<br><br>
We gebruiken jouw gegevens niet om jou bij je bezoek aan Nerdygadgets.shop andere prijzen te tonen dan aan andere klanten. Het kan wel voorkomen dat als je ons opnieuw bezoekt we de prijs van sommige producten inmiddels hebben aangepast en dat prijzen tussen Nederland en België verschillen. Als je hebt gekozen voor je eigen Nerdygadgets.shop, dan tonen wij je ook advertenties op Nerdygadgets.shop die zijn afgestemd op jouw interesses. Denken wij bijvoorbeeld dat je van sporten houdt, dan zullen we advertenties laten zien waarvan wij denken dat deze relevant zijn voor sporters. Als je niet kiest voor je eigen Nerdygadgets.shop zal je nog steeds advertenties zien, alleen zijn dit advertenties die mogelijk minder goed aansluiten op jouw interesses. Meer informatie over hoe wij jouw data gebruiken voor het tonen van persoonlijke advertenties vind je hierna onder het kopje “gepersonaliseerde advertenties buiten Nerdygadgets.shop”. Let op: als je in de instellingen van je smartphone tracking hebt afgewezen voor de Nerdygadgets.shop app, dan kan je persoonlijke advertenties pas aanzetten als je eerst de tracking in je smartphone-instellingen weer hebt aangezet.
<br><br>
Als je niet (langer) prijs stelt op een eigen Nerdygadgets.shop, kun jij je toestemming altijd wijzigen of intrekken. Binnen 24 uur hebben we je aangepaste voorkeuren in onze systemen doorgevoerd.
<br><br>
Gepersonaliseerde berichten<br>
Via e-mail en pushnotificatie
We hebben geregeld aanbiedingen, speciale acties en nieuwtjes die we met je willen delen. We delen die graag via e-mail of, als je de Nerdygadgets.shop app gebruikt, via pushnotificaties. Als je bij ons een account hebt en één of meerdere bestellingen hebt geplaatst, e-mailen we je (en/of sturen we je pushnotificaties met) suggesties, informatie over onze artikelen en diensten op basis van je aankopen en reviewverzoeken, tenzij je hebt aangegeven deze niet te willen ontvangen.
<br><br>
Als je ons daarvoor toestemming geeft, kunnen wij jou ook andere informatie mailen of je daarover pushnotificaties sturen, zoals de dagaanbieding, algemene winacties of persoonlijke aanbevelingen en informatie. We maken de inhoud van deze berichten relevanter voor je door de inhoud te baseren op je aankopen en bezoekgeschiedenis van maximaal 3 jaar geleden. We gebruiken hier ook jouw algemene klantinfo voor, zoals je leeftijd of geslacht. Als je zulke berichten liever niet ontvangt of je voorkeuren wilt aanpassen, kan je de instellingen direct hier wijzigen. Pushnotificaties kun je uitzetten via het instellingenmenu in de Nerdygadgets.shop app of in je smartphone-instellingen.
<br><br>
Wij kunnen je alleen persoonlijke aanbevelingen en informatie sturen als jij hebt gekozen voor je eigen Nerdygadgets.shop. Deze persoonlijke berichten zijn gebaseerd op het interesseprofiel dat wij van je samen hebben gesteld. Je keuze voor een eigen Nerdygadgets.shop kan je altijd wijzigen of intrekken.
<br><br>
We gebruiken bij onze communicatie via e-mail en pushnotificaties technologie die ons kan vertellen of jij onze berichten leest en op welke hyperlinks jij in die berichten klikt. Dat doen we voor analysedoeleinden om bijvoorbeeld na te gaan of een e-mail veel gelezen wordt of niet. Alleen met jouw toestemming kunnen we deze informatie ook gebruiken om onze communicatie naar jou persoonlijker en dus relevanter maken. Deze toestemming kan je altijd intrekken.
<br><br>
In onze app: via in-app notificaties<br>
Je kan van ons ook notificaties ontvangen in de app zelf. Bijvoorbeeld met aanbiedingen, speciale acties en nieuwtjes die we met je willen delen. Of met andere informatie die voor jou relevant kan zijn. Deze notificaties zijn soms voor iedereen hetzelfde, maar we sturen je ook notificaties die speciaal voor jou bedoeld zijn. Deze persoonlijke notificaties zijn gebaseerd op je accountgegevens en zoek-, surf- en aankoopgeschiedenis bij Nerdygadgets.shop. Zo kunnen we de inhoud van deze notificaties relevant voor je te maken. We doen dit alleen met jouw toestemming en die toestemming kan je altijd intrekken.
<br><br>
Gepersonaliseerde advertenties buiten Nerdygadgets.shop<br>
Wij, onze advertentienetwerken en mediabureaus (onze ‘mediapartners’) kunnen je persoonlijke advertenties tonen op websites buiten Nerdygadgets.shop als je hiervoor toestemming hebt gegeven. De personalisatie gebeurt op basis van de interesseprofielen die we van je hebben, gecombineerd met interesseprofielen die onze mediapartners mogelijk van je hebben. Hoe wij dit interesseprofiel bepalen vind je hierna onder het kopje “hoe wij je interesseprofiel bepalen”.
<br><br>
We kunnen je buiten Nerdygadgets.shop herkennen op basis van cookietechnieken en het advertentienummer dat gekoppeld is aan het apparaat waarmee je surft, wanneer je toestemming hebt gegeven voor het gebruik van klik- en zoekgedrag voor persoonlijke advertenties buiten Nerdygadgets.shop. Wanneer je toestemming hebt gegeven voor persoonlijke advertenties buiten Nerdygadgets.shop op basis van bestellingen en algemene klantinfo kunnen we ook gebruikmaken van een versleutelde unieke code op basis van een e-mailadres, telefoonnummer of postcode en huisnummer. Naast de unieke code delen we een of meerdere interesseprofiel(en) waarin Nerdygadgets.shop je heeft ingedeeld (bijvoorbeeld: “tennissers”) om je buiten Nerdygadgets.shop relevante advertenties te kunnen tonen van Nerdygadgets.shop of onze partners.
<br><br>
Als je geen toestemming geeft voor gepersonaliseerde advertenties buiten Nerdygadgets.shop, dan zul je nog steeds advertenties zien, ook van Nerdygadgets.shop, alleen zijn de advertenties dan niet gebaseerd op de gegevens die wij van jou hebben. Als je in de instellingen van je smartphone tracking hebt afgewezen voor de Nerdygadgets.shop app, dan kan je de optie personalisatie op basis van klik- en zoekgedrag pas aanzetten als je eerst de tracking in je smartphone-instellingen weer hebt aangezet.
<br><br>
Hoe wij jouw interesseprofiel bepalen<br>
Om je eigen Nerdygadgets.shop, onze berichten en advertenties binnen en buiten Nerdygadgets.shop voor jou persoonlijk te maken, moeten wij jouw interesses kunnen bepalen. Wij doen dat door verschillende dingen die wij van jou weten bij elkaar te voegen en je vervolgens in te delen in een of meerdere interessegebieden (bijvoorbeeld sport). Uiteraard alleen met jouw toestemming!
...
<br><br>
Als je ons toestemming hebt gegeven voor het personaliseren op basis van jouw surf- en zoekgedrag, dan verzamelen wij dit met behulp van cookies en vergelijkbare technieken. Meer over cookies lees je in ons cookiebeleid.
<br><br>
Als jij ons toestemming geeft voor het personaliseren op basis van jouw bestellingen en algemene klantinfo, dan voegen wij jouw surf- en zoekgedrag samen met je bestellingen en de algemene klantinfo dat wij van jou hebben. Onder algemene klantinfo valt de informatie die jij hebt ingevuld in je account, zoals jouw geboortedatum of woonplaats en jouw persoonlijke voorkeuren (als je die hebt aangegeven). We kijken dan naar wat je eerder bij ons zocht of kocht, wat er op je verlanglijst staat en welke interesses je toonde door bepaalde artikelen of categorieën te bekijken in onze winkel. Dus het boek dat je net hebt gekocht, geven we dan níet als leestip. Of de inhoud waarin je minder geïnteresseerd bent, tonen we dan onderaan de website. Tevens geven wij je op onze website aanbevelingen welke producten je opnieuw nodig zou kunnen hebben op basis van wat je eerder hebt gekocht, bijvoorbeeld tandpasta.
<br><br>
Op verschillende plekken kun je zelf je voorkeuren bij ons aangeven. Misschien wil je ergens van op de hoogte gehouden worden of wil je artikelen op je verlanglijstje zetten. Deze voorkeuren kun je altijd zelf aanpassen of uitzetten.
<br><br>
Tot slot kunnen wij gegevens van andere partijen gebruiken, indien jij hen hiervoor ook toestemming hebt gegeven. Wij ontvangen van deze partijen enkel een versleutelde, unieke code om je te herkennen, zoals een cookie of een versleuteld e-mailadres, telefoonnummer of postcode en huisnummer, en een of meerdere interessegebied(en) waarin deze andere partij je heeft ingedeeld (bijvoorbeeld: “tennissers”). Een overzicht van partijen van wie wij gegevens ontvangen vind je hier. Als je niet langer wil dat Nerdygadgets.shop die gegevens ontvangt, dan kun jij je toestemming intrekken bij deze partijen.

We kijken bij het personaliseren niet langer dan 3 jaar terug. Indien je geïnteresseerd bent in producten voor kinderen, dan kijken we maximaal 7 jaar terug zodat we je in elke fase waarin je kind zich bevindt de juiste aanbieding kunnen doen. Jouw surf- en zoekgedrag verzamelen we op basis van cookietechnieken en het unieke nummer dat gekoppeld is aan het mobiele apparaat waarmee je surft.

Je kan altijd zelf beheren welke data wij gebruiken voor jouw interesseprofiel door je instellingen te wijzigen.

Toestemming voor het uitwisselen van informatie met Albert Heijn
Wij willen graag onze website, app en communicatie-uitingen zo relevant mogelijk voor jou maken. Daarom, als je een Albert Heijn Premium-klant bent en bij Albert Heijn een voucher voor een Nerdygadgets.shop Select abonnement koopt, kun je er voor kiezen om Albert Heijn en Nerdygadgets.shop onderling informatie uit te laten wisselen over jouw koopgedrag. Als je daarvoor kiest, dan gebruiken wij de informatie over jouw aankopen om jou relevante inhoud te tonen in onze eigen communicatie uitingen, websites en apps, en jou (persoonlijke) aanbiedingen te doen gerelateerd aan de producten die je bij Albert Heijn en Nerdygadgets.shop hebt gekocht. We delen alleen producten tot uiterlijk 27 maanden nadat je die bij ons hebt gekocht en we bewaren de gegevens die we van Albert Heijn ontvangen t/m 27 maanden na je aankoop bij Albert Heijn. Nerdygadgets.shop en Albert Heijn bepalen zelf welke aanbiedingen je krijgt op basis van de ontvangen informatie en de informatie in je account. Deze personalisatie kan op verschillende manieren gebeuren, bijvoorbeeld:

Het is mogelijk dat we zien dat je bij Albert Heijn een product hebt gekocht, waardoor we denken dat wij een product voor jou hebben wat een mooie aanvulling zou zijn. Als je bijvoorbeeld bij Albert Heijn vlees voor op de barbecue hebt gekocht, kunnen wij jou een persoonlijke aanbieding tonen voor een barbecue;
Je koopt bepaalde producten bij Albert Heijn waardoor we een betere inschatting kunnen maken van producten die voor jou interessant zijn. Als we bijvoorbeeld zien dat je producten bij Albert Heijn voor jonge kinderen koopt maar geen luiers bij Nerdygadgets.shop, kunnen we een betere inschatting van de leeftijd van jouw kinderen maken en je hierdoor relevantere aanbiedingen tonen.
De gegeven toestemming beïnvloedt jouw andere toestemmingen niet. Als je dus geen toestemming hebt gegeven voor persoonlijke advertenties op basis van klikgedrag, dan wijzigt dit niet.
We zorgen ervoor dat we alleen informatie uitwisselen als je toestemming hebt gegeven en we zeker weten dat jij bij Albert Heijn en Nerdygadgets.shop met dezelfde gegevens geregistreerd staat. We verifiëren daarom of jij op dezelfde manier in onze systemen staat. We gebruiken hiervoor het e-mailadres waarmee je je geregistreerd hebt bij ons en bij Albert Heijn, en de vouchercode die je gekocht hebt met je AH Premiumaccount. We wisselen geen informatie uit als de gegevens niet overeenkomen.

Je kunt de gegeven toestemming altijd weer intrekken in je Albert Heijn-profiel, en je kunt je altijd direct tot Albert Heijn of Nerdygadgets.shop wenden om inzage in en correctie of verwijdering van jouw gegevens te verzoeken.
...
Verder brengen we jaarlijks Het Grote Speelgoedboek uit. Het Grote Speelgoedboek is bedoeld ter inspiratie voor de verlanglijstjes van kinderen. Het Grote Speelgoedboek wordt per post verspreid onder huishoudens in Nederland en België. Als je geen klant van ons bent beroept Nerdygadgets.shop zich op haar gerechtvaardigd belang om jou Het Grote Speelgoedboek toe te sturen. Zo kunnen we jou informeren over ons assortiment en een helpende hand bieden bij het kiezen van een cadeau voor jouw kind.

Voor de verspreiding van Het Grote Speelgoedboek in Nederland en België zijn adresgegevens gebruikt die zijn verkregen via Whooz B.V. Nerdygadgets.shop verwijdert deze adresgegevens binnen twaalf maanden nadat de gegevens van Whooz zijn ontvangen. Meer informatie over de verwerking van persoonsgegevens door Whooz is terug te vinden op www.whooz.nl. Heb je vragen hierover? Mail deze naar info@nerdygadgets.com.

De Grote Speelgoedboek-app
Om Het Grote Speelgoedboek een nog leukere ervaring te maken hebben we een app gemaakt met extra informatie over speelgoed. Het gebruik van de app is anoniem, tenzij een van je ouders inlogt. Anoniem betekent dat wij niet weten dat jij de app gebruikt. Als een van je ouders inlogt op de app dan kunnen we dat wel weten.

In de app vragen we je voornaam en leeftijd in jaren, zodat meerdere kinderen dezelfde app kunnen gebruiken. Daarnaast kun je in de app aangeven welk speelgoed, merken en categorieën je leuk vindt. Wat jij leuk vindt plus je leeftijd in jaren gebruiken we om de app voor jou aan te passen. Zo zie je vaker content als video’s en plaatjes die passen bij het speelgoed dat jij leuk vindt. Ook gebruiken we jouw leeftijd om de moeilijkheid van de games in te stellen. Als je de games hebt uitgespeeld dan krijg je een diploma met jouw voornaam erop.
...
Als een van je ouders inlogt op de app, houden wij bij hoe jij de app gebruikt. Hiervoor zetten we kleine tekstbestandjes op de telefoon die cookies heten. Zo kunnen we de app nog leuker maken.

Al jouw gegevens die we met de app verzamelen verwijderen we uiterlijk op 1 januari 2023 of anonimiseren we dan. Anonimiseren betekent dat we niet meer weten dat het jouw gegevens zijn. Wil je dat we jouw gegevens in de app eerder verwijderen? Neem dan contact op met onze klantenservice. Zij kunnen je ook helpen als je je gegevens wilt inzien.
...
Indien je bezwaar hebt tegen het feit dat wij jouw klantgegevens combineren met de Whooz-gegevens, zullen wij - indien je ons daarom verzoekt - jouw gegevens daartoe blokkeren. Indien je meer informatie wilt over de Whooz-gegevens, dan kan je deze vinden op de website van Whooz (www.whooz.nl). Vragen over de gegevens van Whooz kan je richten aan info@nerdygadgets.com .

Nerdygadgets.shop wil van tijd tot tijd onderzoeken of een eventuele samenwerking met een andere partij effectief is en wil daarvoor statistische inzichten verzamelen. Daarom delen we jouw klantgegevens en klik- en koopgedrag met behulp van Infosum Ltd., met DPG Media B.V. Ook delen we hiervoor jouw klantgegevens en koopgedrag met Albert Heijn B.V. Deze geaggregeerde statistische inzichten zijn niet herleidbaar naar individuele klanten en worden op geen enkele wijze toegevoegd aan de informatie die Nerdygadgets.shop over jou bewaart. Deze onderzoeken worden uitgevoerd op aparte systemen en de onderliggende gegevens worden direct na het uitvoeren van de analyse verwijderd van deze systemen. Dit doen wij vanuit ons gerechtvaardigd belang.
...
Bij je review wordt automatisch aangegeven of je het product wel/niet hebt gekocht bij Nerdygadgets.shop. Dat komt dus bij je review te staan. Hiermee willen we de transparantie en betrouwbaarheid van de reviews op Nerdygadgets.shop borgen en kunnen onze klanten reviews beter op waarde schatten. Of je het product bij Nerdygadgets.shop hebt gekocht kunnen we checken met behulp van jouw bestelinformatie.

Het is ook mogelijk om een review te schrijven over een zakelijke verkooppartner van Nerdygadgets.shop. Als je iets via Nerdygadgets.shop bij een zakelijke verkooppartner hebt gekocht, krijg je naderhand een e-mail met het verzoek een review achter te laten.
...
Achteraf betalen
Als je artikelen koopt die je niet meteen wilt betalen, kunnen wij je kredietwaardigheid toetsen. We kunnen daarbij gebruikmaken van externe bureaus. Dit staat ook in onze algemene voorwaarden (artikel 5 lid 4).

Social media
Als je social media zoals Facebook gebruikt, kun je via 'like en share' knoppen op Nerdygadgets.shop artikelen die je leuk, nuttig of handig vindt, met je vrienden delen op je social media account. Nerdygadgets.shop krijgt geen toegang tot jouw social media account. Wij raden je aan om het privacybeleid van de social media partijen waar jij een account hebt, goed door te nemen zodat je weet hoe je gegevens worden gebruikt en hoe jij je instellingen kunt aanpassen.
...
Partners die gebruik maken van inloggen via Nerdygadgets.shop
Wij maken inloggen via je Nerdygadgets.shop account mogelijk op de websites van sommige van onze partners. Indien jij hiervan gebruikmaakt krijg je de keuze om gegevens te delen met de partner waardoor met deze gegevens automatisch jouw account op de website van de partner (gedeeltelijk) wordt ingevuld. Het gaat hierbij om jouw naam, adres en emailadres. Wij willen hiermee het inloggen en winkelen via onze partners makkelijker maken.

Voor meer informatie over de wijze waarop onze partners omgaan met jouw gegevens verwijzen wij je naar het privacy beleid van de desbetreffende partner.

De volgende partners bieden inloggen via Nerdygadgets.shop aan:
...
Als jij dat wilt, geven we je persoonsgegevens ook aan andere bedrijven door, bijvoorbeeld als een van onze commerciële partners een aanbieding heeft voor klanten van Nerdygadgets.shop. Dit doen wij dan alleen met jouw uitdrukkelijke toestemming.

Op verzoek van een verzekeraar of een organisatie die een cashback actie aanbiedt, kunnen Nerdygadgets.shop facturen op echtheid worden gecontroleerd. Ook kunnen wij nagaan of bepaalde Nerdygadgets.shop producten zijn geretourneerd. We mogen deze factuur- en productinformatie op verzoek van een verzekeraar of organisatie die een cashback actie aanbiedt delen om onrechtmatig gedrag tegen te gaan, zoals het gebruik van vervalste Nerdygadgets.shop facturen.
...
Wanneer je via ons platform verkoopt als zakelijke verkooppartner dan slaan wij behalve de contactgegevens die je invult in jouw verkoopaccount (de naam van jouw bedrijf, de naam van de contactpersoon van jouw bedrijf, e-mailadres, jouw contactadres (en eventuele andere adressen), betaalgegevens en je telefoonnummer) ook jouw KVK-nummer en jouw btw-nummer op. We kunnen jouw KVK-nummer en btw-nummer gebruiken voor (markt)onderzoeken. Ook gebruiken wij publiek beschikbare gegevens over jouw bedrijf (zoals gegevens die geregistreerd zijn bij de Kamer van Koophandel). Als je gebruikt maakt van de Seller API, dan slaan wij ook de naam, het e-mailadres en het telefoonnummer van de partij die de aansluiting verzorgt. Wanneer jij wijzigingen maakt in de content van een artikel zijn deze wijzigingen, inclusief jouw verkopersnaam op Nerdygadgets.shop, inzichtelijk voor andere verkooppartners, leveranciers en Nerdygadgets.shop.

Nerdygadgets.shop heeft toegang tot de gegevens in het partneraccount ter ondersteuning van de zakelijke verkooppartners.
...
Wanneer je via onze website de Quick-scan hebt aangevraagd, gebruiken wij de gegevens die je hebt ingevuld (de naam van jouw bedrijf, de naam van de contactpersoon van jouw bedrijf en het e-mailadres) om je per e-mail een persoonlijk advies toe te sturen. Wanneer je het telefoonnummer hebt opgegeven, dan gebruiken wij dat om je te informeren over verkopen via Nerdygadgets.shop. Deze gegevens bewaren wij 1 jaar zodat we kunnen beoordelen of je uiteindelijk een zakelijke verkooppartner van Nerdygadgets.shop bent geworden. Wanneer je hebt aangegeven die te willen ontvangen, sturen we potentiële verkooppartners van tijd tot tijd via het opgegeven e-mailadres aanvullende informatie over verkopen via ons platform. Als je deze informatie liever niet ontvangt dan kun je je daarvoor afmelden in de e-mail. Tenzij je na 1 jaar aangeeft de e-mails te willen blijven ontvangen, verwijderen we je e-mailadres.

Waar slaan wij jouw gegevens op?
Wij slaan jouw gegevens op binnen de Europese Economische Ruimte ("EER"). Het kan echter voorkomen dat bepaalde gegevens die we verzamelen, worden doorgegeven aan of opgeslagen op een bestemming buiten de EER, bijvoorbeeld omdat een van onze externe dienstverleners daar gevestigd is. Wanneer hiervan sprake is, zorgen wij dat dit gebeurt op een veilige en rechtmatige manier. Nerdygadgets.shop zal in dergelijke gevallen passende maatregelen nemen om te waarborgen dat je gegevens zo goed mogelijk worden beschermd, zoals het overeenkomen met de ontvangers van standaardbepalingen inzake gegevensbescherming die door de Europese Commissie zijn opgesteld. Mocht je hier vragen over hebben dan kun je daarvoor contact opnemen met onze Functionaris voor de Gegevensbescherming. Dit kun je doen door te e-mailen naar info@nerdygadgets.com .

Hoe worden jouw gegevens beveiligd?
Nerdygadgets.shop neemt veel maatregelen om jouw persoonsgegevens te beveiligen. Zowel op organisatorisch als technisch gebied. Wij hebben een groep specialisten in huis die dagelijks werken aan het beveiligen van onze systemen en het zoeken naar kwetsbaarheden. Door een strenge toegangscontrole zorgen wij dat jouw persoonsgegevens alleen toegankelijk zijn voor medewerkers waarvoor het noodzakelijk is dat zij daarmee werken. Daarnaast laten we bij Nerdygadgets.shop regelmatig onze beveiliging toetsen door externe experts. Geven we jouw gegevens aan iemand anders? Dan eisen we dat die ander net zo zorgvuldig met jouw gegevens omgaat als wij. Mocht je het gevoel hebben dat dit niet gebeurt, laat het ons dan weten via onze klantenservice.

Hoe gaan wij om met gegevens van kinderen?
Onze dienstverlening is niet gericht op kinderen. Dit betekent dat het gebruik van Nerdygadgets.shop door klanten jonger dan 18 jaar alleen is toegestaan met de nadrukkelijke toestemming van een ouder of voogd. Wel hebben we De Grote Speelgoedboek app die voor kinderen ontwikkeld is. De app is bedoeld om Het Grote Speelgoedboek tot leven te brengen en ouders een helpende hand te bieden tijdens de feestdagen. Kinderen kunnen via deze app geen producten bij ons bestellen.
...
Jij hebt het recht om een klacht in te dienen over de wijze waarop wij met jouw gegevens omgaan. Wanneer jij een klacht hebt, dan lossen wij dat het liefst zelf met je op. Neem daarvoor contact op met onze klantenservice. Maar je hebt ook het recht om een klacht in te dienen bij onze Functionaris voor de Gegevensbescherming. Dit kun je doen door te e-mailen naar info@nerdygadgets.com. Tot slot heb je het recht om je met jouw klacht te wenden tot de Autoriteit Persoonsgegevens.
